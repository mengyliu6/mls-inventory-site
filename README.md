...
下面是每张飞书多维表可以先录入的示例数据。字段名建议和前面的英文名保持完全一致。

### `rooms` 示例

| id | name | note | sort_order | created_at | updated_at |
| --- | --- | --- | --- | --- | --- |
| `room-1` | `房间1` | `主库存区` | `1` | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `room-2` | `房间2` | `仪表与主机区` | `2` | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `room-3` | `房间3` | `屏幕与面板区` | `3` | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `room-4` | `房间4` | `备货与临时周转区` | `4` | `2026-06-03 09:00` | `2026-06-03 09:00` |

### `racks` 示例

| id | room_id | code | name | x | y | w | h | slot_count | note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `rack-1-b1` | `room-1` | `B1` | `B1 大货架` | `8` | `16` | `25` | `27` | `8` | `主货架` |
| `rack-1-b2` | `room-1` | `B2` | `B2 大货架` | `39` | `16` | `25` | `27` | `8` | `主货架` |
| `rack-1-b3` | `room-1` | `B3` | `B3 大货架` | `70` | `16` | `22` | `27` | `8` | `主货架` |
| `rack-2-a1` | `room-2` | `A1` | `A1 大货架` | `8` | `18` | `26` | `28` | `8` | `仪表区` |
| `rack-2-a2` | `room-2` | `A2` | `A2 大货架` | `40` | `18` | `26` | `28` | `8` | `仪表区` |
| `rack-3-c1` | `room-3` | `C1` | `C1 大货架` | `10` | `20` | `26` | `30` | `8` | `屏幕区` |
| `rack-4-d1` | `room-4` | `D1` | `D1 大货架` | `12` | `18` | `28` | `30` | `8` | `周转区` |

### `products` 示例

| id | vehicle | model | image | system_version | storage | rack_id | slot_no | slot_label | stock | low_stock_threshold | note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `p-1` | `GMC 索罗德仪表 14-18` | `JT5-1370` | 空 | `Linux` | `无` | `rack-2-a1` | `2` | `A1-2` | `8` | `2` | `一台在直播间` |
| `p-2` | `凯迪拉克凯雷德 07-14` | `JT5-1508` | 空 | `Linux` | `无` | `rack-2-a1` | `4` | `A1-4` | `13` | `2` | `一台在直播间` |
| `p-3` | `福特 F150 仪表 15-21` | `JT5-1397` | 空 | `Linux` | `无` | `rack-2-a2` | `6` | `A2-6` | `10` | `2` | `直播样机` |
| `p-4` | `4Runner 2010-2022` | `WE-8103` | 空 | `安卓12` | `6+128` | `rack-1-b1` | `8` | `B1-8` | `5` | `2` | `亮黑` |
| `p-5` | `Tacoma 2016-2022` | `WE-8106A` | 空 | `安卓12` | `4+64` | `rack-1-b1` | `7` | `B1-7` | `1` | `2` | `枪色+电镀银` |
| `p-6` | `Grand Cherokee 2014-2022` | `WE-8504` | 空 | `安卓14` | `8+128` | `rack-1-b2` | `8` | `B2-8` | `30` | `2` | 空 |
| `p-7` | `14-20 GX` | `16GXSI` | 空 | `Linux` | 空 | `rack-1-b1` | `1` | `B1-1` | `100` | `2` | 空 |

说明：`image` 如果还没有图片，可以留空。`slot_label` 是冗余显示字段，系统主要依赖 `rack_id + slot_no`。

### `movements` 示例

| id | product_id | type | qty | at | user_id | user_name | sales_person | stock_before | stock_after | source | note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `m-1` | `p-7` | `in` | `67` | `2026-05-14 10:00` | `u-admin` | `管理员` | 空 | `33` | `100` | `form` | `0514 入库` |
| `m-2` | `p-7` | `out` | `17` | `2026-05-27 16:20` | `u-wendy` | `Wendy` | `Abby` | `100` | `83` | `slot` | `仓库图示直接出库` |
| `m-3` | `p-4` | `in` | `5` | `2026-05-07 09:30` | `u-hai` | `Hai` | 空 | `0` | `5` | `form` | `0507 入库` |
| `m-4` | `p-5` | `out` | `2` | `2026-05-20 14:10` | `u-hai` | `Hai` | `Wendy` | `3` | `1` | `form` | `样品出库` |
| `m-5` | `p-3` | `in` | `11` | `2026-05-05 11:40` | `u-admin` | `管理员` | 空 | `0` | `11` | `form` | `05 前入库` |

说明：`qty` 一律填正数，入库/出库由 `type` 判断。出库时 `sales_person` 必填，入库可以为空。

### `users` 示例

| id | name | role | active | created_at | updated_at |
| --- | --- | --- | --- | --- | --- |
| `u-admin` | `管理员` | `admin` | 勾选 | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `u-wendy` | `Wendy` | `editor` | 勾选 | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `u-hai` | `Hai` | `editor` | 勾选 | `2026-06-03 09:00` | `2026-06-03 09:00` |
| `u-viewer` | `仓库查看` | `viewer` | 勾选 | `2026-06-03 09:00` | `2026-06-03 09:00` |

角色说明：

| role | 含义 |
| --- | --- |
| `admin` | 管理员，默认可以编辑全部大货架 |
| `editor` | 仓库编辑，需要在权限表里分配可编辑大货架 |
| `viewer` | 只读查看 |

### `user_rack_permissions` 示例

| id | user_id | rack_id | can_edit |
| --- | --- | --- | --- |
| `urp-wendy-b1` | `u-wendy` | `rack-1-b1` | 勾选 |
| `urp-wendy-a1` | `u-wendy` | `rack-2-a1` | 勾选 |
| `urp-hai-b1` | `u-hai` | `rack-2-b1` | 勾选 |
| `urp-hai-c1` | `u-hai` | `rack-3-c1` | 勾选 |

说明：`u-admin` 不需要录入权限记录，系统默认管理员拥有全部权限。

### `sales_people` 示例

| id | name | active | created_at |
| --- | --- | --- | --- |
| `sales-wendy` | `Wendy` | 勾选 | `2026-06-03 09:00` |
| `sales-hai` | `Hai` | 勾选 | `2026-06-03 09:00` |
| `sales-abby` | `Abby` | 勾选 | `2026-06-03 09:00` |

说明：出库时输入了新的销售人员，系统可以自动追加到这张表。

### `field_options` 示例

| id | field | value | active | sort_order |
| --- | --- | --- | --- | --- |
| `opt-system-linux` | `system_version` | `Linux` | 勾选 | `1` |
| `opt-system-android-12` | `system_version` | `安卓12` | 勾选 | `2` |
| `opt-system-android-13` | `system_version` | `安卓13` | 勾选 | `3` |
| `opt-system-android-14` | `system_version` | `安卓14` | 勾选 | `4` |
| `opt-storage-none` | `storage` | `无` | 勾选 | `1` |
| `opt-storage-4-64` | `storage` | `4+64` | 勾选 | `2` |
| `opt-storage-6-128` | `storage` | `6+128` | 勾选 | `3` |
| `opt-storage-8-128` | `storage` | `8+128` | 勾选 | `4` |

说明：`field` 目前只建议使用 `system_version` 和 `storage`。型号不建下拉项。
